...
// /**
//  * Lightweight lock to prevent overlapping pairing runs in the same second/request
//  */
// function buytap_pair_lock_acquire($key = 'global', $ttl = 10) {
//     $lock_key = "buytap_pair_lock_{$key}";
//     if (get_transient($lock_key)) return false;      // already running
//     set_transient($lock_key, 1, $ttl);               // acquire
//     return $lock_key;
// }
